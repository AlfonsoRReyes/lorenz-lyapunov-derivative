# Objective
Implementing an algorithm to determine the Lyapunov exponent using the equations 6.16, 6.17, 6.18, and 6.20 in Chapter 6 "The Chaotic Motion of Dynamical Systems".
...
## Discovery
Wh0en discretizing the method in page 17 of chapter 6 (page 169 of the book), we find some perplexing results. The link to the chapter can be downloaded from https://www.compadre.org/osp/items/detail.cfm?ID=9921.

We will refer to the method in page 17 (169) as the "better method". When the "better method" is implemented and running coverges nicely to values very close to 0.9056. We have tested the algorithm at a perturbation in a variable of state at 1e-9, 1e-12, 1e-14, etc.
